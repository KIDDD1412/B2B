...
<!--页面顶部结束-->
	...
	<div class="location ared">
			当前位置： <a href="before?id=0">首页</a> > 个人中心 >店铺信息修改
		</div>
		<div class="AreaL">
			<div class="box">
				<div class="box_2">
		...
		<div class="AreaR">
			<form:form action="updateStore" method="post" modelAttribute="store" enctype="multipart/form-data">
		<table width="99%" align="center" border="0" cellpadding="5"
					cellspacing="1" bgcolor="#dddddd">
			<caption>
				<font size=4 face=华文新魏>修改店铺信息</font>
