...
<!--页面顶部结束-->
	...
	<div class="location ared">
		当前位置： <a href="before?id=0">首页</a> > 个人中心 > 交易流水
		</div>
		<div class="AreaL">
			<div class="box">
				<div class="box_2">
		...
		<div class="AreaR">
			...
			支出
				...
				<table width="99%" align="center" border="0" cellpadding="5"
					...
					<c:forEach var="mf" items="${myTrade_out}"> 
						<tr>
							<td bgcolor="#ffffff" align="center">${mf.tid}</td>
							<td bgcolor="#ffffff" align="center">${mf.order_id}</td>
							<td align="center" bgcolor="#ffffff">${mf.uname}</td>
							<td align="center" bgcolor="#ffffff">${mf.amount}</td>
							<td align="center" bgcolor="#ffffff">${mf.date}</td>
						</tr>
					</c:forEach>
				</table>
				<table width="99%" align="center" border="0" cellpadding="5"
					...
					<c:forEach var="mf" items="${myTrade_in}"> 
						<tr>
							<td bgcolor="#ffffff" align="center">${mf.tid}</td>
							<td bgcolor="#ffffff"  align="center">${mf.order_id}</td>
							<td align="center" bgcolor="#ffffff">${mf.uname}</td>
