	...
	<script type="text/javascript">
  		...
  		function checkDel(id){
  			if(window.confirm("是否删除该商品？")){
  				window.location.href = "/B2B/updateStoreDetail/deleteAGoods?id="+id;
  			}
  		}
  </script>
...
<!--页面顶部结束-->
	...
	<div class="location ared">
			当前位置： <a href="userCenter_trade">个人中心</a> >  <a href="userCenter_store">我的店铺 </a>> 商品下架
		</div>
		<div class="AreaL">
			<div class="box">
				<div class="box_2">
	...
	<c:if test="${allGoods.size() != 0 }">
		<form action="updateStoreDetail/deleteGoods" name="deleteForm">
		<table width="99%" align="center" border="0" cellpadding="5"
			...
			<c:forEach items="${allGoods }" var="goods">
				<tr onmousemove="changeColor(this)" onmouseout="changeColor1(this)">
					<td><input type="checkbox" name="ids" value="${goods.gid }"/>${goods.gid }</td>
					<td>${goods.gname }</td>
					<td>
					...
					<td>
						<a href="javascript:checkDel('${goods.gid }')">删除</a>
					</td>
				</tr>
			</c:forEach>
			<tr>
