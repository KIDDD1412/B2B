...
<script type="text/javascript">
	function checkDel(id){
		if(window.confirm("是否真的关闭此店铺？")){
			window.location.href = "/deleteStore?storesn="+id;
		}
	}
</script>
...
<!--页面顶部结束-->
	...
	<div class="location ared">
			当前位置： <a href="before?id=0">首页</a> > 个人中心 > 我的店铺
		</div>
		<div class="AreaL">
			<div class="box">
				<div class="box_2">
		...
		<div class="AreaR">
			  	...
			  	<div class="location ared">
					...
					<c:forEach var="mo" items="${myStore}"> 
						<tr>
							<td bgcolor="#ffffff"  align="center">${mo.sname}</td>
							<td bgcolor="#ffffff"  align="center">
							<c:if test="${mo.sstatus==1}">通过
							<td align="center" bgcolor="#ffffff">
							<a style="text-decoration: none;" class="f6" href="storeDetail?storesn=${mo.sid}" target="_blank">详情</a></td>
							</c:if>
						    <c:if test="${mo.sstatus==0}">未通过</c:if>
							</td>
							
							<td align="center" bgcolor="#ffffff">
							<a style="text-decoration: none;" class="f6" href="updateStoreByid?storen=${mo.sid}" target="_blank">修改店铺信息</a>
							</td>
							<td align="center" bgcolor="#ffffff">
							<a style="text-decoration: none;" class="f6" href="javascript:checkDel('${mo.sid}')" >关闭店铺</a>
							</td>
						</tr>
					</c:forEach>
				</table>
