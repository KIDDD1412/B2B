...
<!--页面顶部结束-->
	...
	<div class="location ared">
			当前位置： <a href="before?id=0">首页</a> > 个人中心 > 店铺申请
		</div>
		<div class="AreaL">
			<div class="box">
				<div class="box_2">
		...
		<div class="AreaR">
		<form:form action="addStore" method="post" modelAttribute="store" enctype="multipart/form-data">
		<table width="99%" align="center" border="0" cellpadding="5"
					cellspacing="1" bgcolor="#dddddd">
			<caption>
				<font size=4 face=华文新魏>申请店铺</font>
			</caption>
			<tr>
