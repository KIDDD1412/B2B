...
<div class="itemgood_nr clearfix">
							<ul>
								<c:forEach items="${storelist }" var="sg" varStatus="loop">
									<li>
										<div>
											<p class="pic">
												<a href="storeDetail?id=${sg.sid }">
												<img src="logos/${sg.spicture}" /></a>
											</p>
											<p class="wz">
												<strong><a href="goodsDetail?id=${sg.sid }">${sg.sname }</a></strong>
											</p>
										</div>
									</li>
									<!-- 在每6个商店后加入换行 -->
